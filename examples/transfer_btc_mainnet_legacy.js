...
const multisigInit = async () => {
  try {
    ...
    const receiverCredentials = {
      address: '13NCwgbWrGCANyLVFMJw2GvpwSUjGm9S5G',
    };
  ...
  // First successful on-chain transaction sending to legacy addresses
  // https://mempool.space/tx/98afe884cda6d196038cdfae80f0819114437a839a2284b165bf2a52862887a7
};
